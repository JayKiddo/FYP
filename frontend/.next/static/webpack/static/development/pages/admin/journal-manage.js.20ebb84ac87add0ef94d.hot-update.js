...
var listJournalForManage = function listJournalForManage() {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1___default()("".concat(_config__WEBPACK_IMPORTED_MODULE_2__["API"], "/journals"), {
    method: 'GET'
  }).then(function (response) {
    return response.json();
  })["catch"](function (error) {
...
var deleteJournal = function deleteJournal(slug, token) {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1___default()("".concat(_config__WEBPACK_IMPORTED_MODULE_2__["API"], "/journal/").concat(slug), {
    method: 'DELETE',
    headers: {
      Accept: 'application/json',
...
var updateJournal = function updateJournal(journal, token, slug) {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1___default()("".concat(_config__WEBPACK_IMPORTED_MODULE_2__["API"], "/journal/").concat(slug), {
    method: 'PUT',
    headers: {
      Accept: 'application/json',
...
//# sourceMappingURL=journal-manage.js.20ebb84ac87add0ef94d.hot-update.js.map