...
var ProfileUpdate = function ProfileUpdate() {
  ...
  var handleSubmit = function handleSubmit(event) {
    ...
    Object(_actions_member__WEBPACK_IMPORTED_MODULE_11__["updateProfile"])(token, formData).then(function (data) {
      if (data.error) {
        ...
        Object(_actions_auth__WEBPACK_IMPORTED_MODULE_13__["updateMember"])(data, function () {
          setValues(_objectSpread({}, values, {
            username: data.username,
            name: data.name,
            email: data.email,
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_7___default.a.Fragment, {
    ...
    src: "".concat(_config_js__WEBPACK_IMPORTED_MODULE_12__["API"], "/member/photo/").concat(usernameForPhoto),
...
//# sourceMappingURL=update.js.2c22a0ac59ac7ee7ce99.hot-update.js.map